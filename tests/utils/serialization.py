...
from dessia_common.utils.types import deserialize_typing, serialize_typing_types, MethodType, ClassMethodType,\
...
serialized_typing = serialize_typing_types(test_typing)
...
# test_typing = ClassMethodType[StandaloneObject]
# serialized_typing = serialize_typing_types(test_typing)
