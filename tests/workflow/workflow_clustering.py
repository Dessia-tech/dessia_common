...
output_jsondict_to_object = CategorizedList.dict_to_object(output_json_to_dict)
...
# Test
assert(output_jsondict_to_object == CategorizedList.dict_to_object(reference_output))
