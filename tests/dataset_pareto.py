...
categorized_pareto = ClusteredDataset.from_pareto_sheets(all_cars_with_features, costs, 7)
...
categorized_pareto = ClusteredDataset.from_pareto_sheets(all_cars_with_features, costs, 1)
pareto_plot_data = categorized_pareto.plot_data()
...
try:
    ClusteredDataset.from_pareto_sheets(all_cars_with_features, [[1,2,3]], 1)
