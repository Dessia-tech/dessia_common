...
class ForEach(Block):
    ...
    def dict_to_object(cls, dict_: JsonSerializable, force_generic: bool = False,
        ...
        return cls(workflow_block=workflow_block, iter_input_index=iter_input_index, name=dict_.get('name', ''))
...
class WorkflowBlock(Block):
    ...
    def dict_to_object(cls, dict_):
        return cls(workflow=Workflow.dict_to_object(dict_['workflow']),
                   name=dict_.get('name', ''))
