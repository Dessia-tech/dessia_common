...
class DessiaCluster(DessiaObject):
    """
    ...
    def check_method_name(self, method: str):
        ...
        elif method.lower() in clusterings_dict['AgglomerativeClustring']:
            new_method_name = 'AgglomerativeClustring'
    ...
    def init_cluster_object(self):
        ...
        elif self.method == 'AgglomerativeClustring':
    ...
    def fit(self, data):
        ...
        """
        if isinstance(data, DessiaObject):
